                    ...
                    <v-card-text>
                        <v-form @submit.prevent="saveMember">
                            <v-row>
                                ...
                                <v-col cols="12" md="6">
                                    <v-text-field label="ปี" v-model="form.year_sys" :error-messages="error.year_sys" />
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-select label="เปิด-ปิด รอบการประเมิน" v-model="form.status_sys" :items="[{title:'เปิด',value:'y'},{title:'ปิด',value:'n'}]" :error-messages="error.status_sys" />
                                </v-col>
                        ...
                        <v-table>
                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_sys">
                                    ...
                                    <td class="text-center border">{{ items.day_out }}<br><span class="opacity-75">{{ items.detail_indicate }}</span></td>
